                                        ...
                                        <NinjaCardContent className="p-4">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="text-right">
                                                    <div className={`text-xs px-2 py-1 rounded-full ${mentor.availability === 'Online' ? 'bg-safe/20 text-safe' : 'bg-warning/20 text-warning'
                                                        }`}>
                                                        {mentor.availability}
                                                    </div>
                                ...
                                <NinjaCard>
                                    <NinjaCardContent className="p-4">
                                        <p className="text-sm text-muted-foreground mb-4">
                                            Your identity will be completely protected. Describe your situation and we'll connect you with a mentor or authority figures, fully anonymously.
                                        </p>
                                        <textarea
