                        ...
                        <NinjaCardContent className="space-y-3">
                            {recentThreats.map((threat) => (
                                <div key={threat.id} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                                    <div className="flex items-center space-x-3">
                                        <div className={`w-3 h-3 rounded-full ${threat.severity === 'High' ? 'bg-danger' : 'bg-warning'
                                            }`} />
                                        <div>
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                                                    ...
                                                    <span className={`px-2 py-1 rounded-full text-xs ${module.difficulty === 'Beginner' ? 'bg-safe/20 text-safe' :
                    ...
                    <NinjaCard>
                        ...
                        <NinjaCardContent className="space-y-3">
                            {leaderboard.map((user) => (
                                <div
                                    key={user.rank}
                                    className={`flex items-center justify-between p-3 rounded-lg ${user.name === 'You' ? 'bg-primary/20 border border-primary/30' : 'bg-muted/50'
                                        }`}
                                >
                                    <div className="flex items-center space-x-3">
