    ...
    <div className="relative flex items-end gap-3 p-4 bg-card/80 backdrop-blur-md border-t border-border fade-in">
      ...
      <div className={cn("relative flex-1 transition-transform duration-200", isFocused && "scale-[1.01]")}>
        <Textarea
          ...
          disabled={disabled}
          className="min-h-[52px] max-h-[120px] resize-none rounded-2xl border-border bg-background/60 px-4 py-3.5 text-base placeholder:text-muted-foreground/60 focus-visible:ring-primary/30 focus-visible:ring-offset-0 transition-shadow duration-300"
          rows={1}
        />
